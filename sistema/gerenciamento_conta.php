                                ...
                                <div class="modal-body">
                                    <form method="POST" action="crud/crud_UpdateCli.php">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="recipient-name" name="cnpj" value="<?php {
                                                                                                                                echo $dados["cnpj"];
                                                                                                                            } ?>">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="recipient-name" name="telefone" value="<?php {
                                                                                                                                    echo $dados["telefone"];
                                                                                                                                } ?>">
                                        </div>
                                        <div class="mb-3">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            <label for="recipient-name" class="col-form-label"> senha da conta:</label>
                                            <input type="text" class="form-control" id="recipient-name">
                                        </div>
